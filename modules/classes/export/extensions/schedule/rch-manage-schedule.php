...
$schedule_templates = $wpdb->get_results( "SELECT * FROM " . $wpdb->prefix . "rch_template where `opration`='schedule_export_template'" );
?>
<div class="rch_section_wrapper">
        <div class="rch_content_data_header rch_section_wrapper_selected">
                <div class="rch_content_title"><?php esc_html_e( 'Manage Schedule Export', 'rch-woo-import-export' ); ?></div>
                <div class="rch_layout_header_icon_wrapper"></div>
        </div>
        <div class="rch_section_content rch_show rch_schedule_export_section">
                        ...
                        <thead>
                                <tr>
                                        <td class="rch_log_check_wrapper">
                                                <input type="checkbox" class="rch_checkbox rch_log_check_all" id="rch_schedule_log_check_all" value="1"/>
                                                <label for="rch_schedule_log_check_all" class="rch_checkbox_label"></label>
                                        </td>
                        ...
                        <tbody>
                            ...
                            if ( ! empty( $schedule_templates ) ) {
                                    ...
                                    foreach ( $schedule_templates as $template ) {
                                            ...
                                            $interval = isset( $options[ 'rch_export_interval' ] ) ? $options[ 'rch_export_interval' ] : "";
                                            ...
                                            $next_scheduled = date_i18n( $date_format . " " . $time_format, wp_next_scheduled( 'rch_cron_schedule_export', array( absint( $id ) ) ) );
                                            ?>
