...
<div class="rch_section_wrapper">
    <div class="rch_content_data_header rch_schedule_export">
        <div class="rch_content_title"><?php esc_html_e( 'Set Cron for Export', 'rch-woo-import-export' ); ?></div>
        ...
        <div class="rch_content_data_wrapper">
            <table class="rch_content_data_tbl table table-bordered">
                    ...
                    <td>
                        <div class="rch_options_data">
                            ...
                            <div class="rch_options_data_content">
                                ...
                                <div class="rch_export_default_hint"><?php esc_html_e( 'Give any name for schedule', 'rch-woo-import-export' ); ?></div>
                            </div>
                        </div>
                    </td>
                    <td >
                        <div class="rch_options_data">
                            <div class="rch_options_data_title"><?php esc_html_e( 'Export Interval', 'rch-woo-import-export' ); ?></div>
                            <div class="rch_options_data_content">
                                <select class="rch_content_data_select rch_sceduled_export_interval" data-placeholder="<?php esc_attr_e( 'Select Interval', 'rch-woo-import-export' ); ?>" name="rch_export_interval">
                                    <?php
                ...
                <tr>
                    <td>
                        <div class="rch_options_data">
                            <div class="rch_options_data_title"><?php esc_html_e( 'Export Interval Start Time', 'rch-woo-import-export' ); ?></div>
                            <div class="rch_options_data_content">
                                <select class="rch_content_data_select rch_sceduled_export_interval_start_time" data-placeholder="' . esc_attr__('Select Interval TIme', 'rch-woo-import-export') . '" name="rch_interval_start_time">
                                ...
                                <div class="rch_export_default_hint"><?php esc_html_e( 'Default : Current time, Value : 00:00 to 23:30', 'rch-woo-import-export' ); ?></div>
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="rch_options_data">
                            <div class="rch_options_data_content">
                                <input type="checkbox" class="rch_checkbox rch_migrate_package" id="is_migrate_package" name="is_migrate_package" value="1"/>
                                <label for="is_migrate_package" class="rch_checkbox_label"><?php esc_html_e( 'Migrate Package', 'rch-woo-import-export' ); ?></label>
                            </div>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                        ...
                        <div class="rch_options_data_send_mail">
                            <div class="rch_schedule_mail_wrapper">
                                <div class="rch_options_data">
                                    ...
                                    <div class="rch_options_data_content">
                                        ...
                                        <div class="rch_export_default_hint"><?php esc_html_e( 'Ex. example@gmail.com, demo@yahoo.com', 'rch-woo-import-export' ); ?></div>
                                    </div>
                                </div>
                            </div>
                            <div class="rch_schedule_mail_wrapper">
                            ...
                            <div class="rch_schedule_mail_wrapper">
                                <div class="rch_options_data">
                                    ...
                                    <div class="rch_options_data_content">
                                        <textarea class="rch_sceduled_export_msg" name="rch_scheduled_email_msg"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="rch_save_scheduled_btn_wrapper"> 
                <div class="rch_btn rch_btn_secondary rch_btn_radius rch_save_scheduled_btn">
