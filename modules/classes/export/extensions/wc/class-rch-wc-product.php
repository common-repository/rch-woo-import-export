...
namespace rch\export\wc\product;
...
class RCH_WC_Product extends \rch\export\base\RCH_Export_Base {

    private $product;

    public function __construct() {

        add_filter('rch_export_posts_where', array($this, 'set_variable_condition'), 10, 1);

        add_filter('rch_export_post_meta', array($this, 'rch_export_product_meta'), 10, 3);
    }
    ...
    public function pre_process_fields(&$export_fields = array(), $export_type = array()) {
        ...
        $export_fields['product_arrtibute'] = array(
            'title' => __("Product Attribute", 'rch-woo-import-export'),
            'isFiltered' => true,
        ...
        $export_fields['product_fields'] = array(
            'title' => __("Product Data", 'rch-woo-import-export'),
            'isFiltered' => true,
            'data' => $this->format_fields($product_fields, 'wc-product', "rch_cf")
        );
    ...
    public function get_attribute_fields($type = "wc-product-attr", $export_type = array()) {
        ...
        if (!empty($product_custom_attribute)) {
            ...
            foreach ($product_custom_attribute as $attribute) {
                $attributes[] = array(
                    'name' => $this->fix_title($attribute->meta_key),
                    'type' => $type,
                    'isTax' => false,
    ...
    public function format_fields($fields_data = array(), $new_type = 'wc-product', $default_type = "rch_cf") {
            ...
            switch ($field_type) {
                ...
                case 'rch_cf':
                    ...
                    switch ($metaKey) {
                        ...
                        case '_sale_price_dates_to':
                            ...
                            $export_data[$field_name] = apply_filters('rch_export_post_meta', $this->apply_user_function($_dates, $is_php, $php_func), $item);
                        ...
                        case '_tax_class':
                            ...
                            if ('taxable' == $tax_status) {
                                $export_data[$field_name] = apply_filters('rch_export_post_meta', $this->apply_user_function('standard', $is_php, $php_func), $item);
                            }
                            unset($tax_status);
                ...
                case "wc-product":
                    ...
                    switch ($metaKey) {
                        ...
                        case '_upsell_ids':
                            ...
                            $indicator = isset($field_option['indicator']) ? rch_sanitize_field($field_option['indicator']) : "sku";
                    ...
                    $export_data[$field_name] = apply_filters('rch_export_post_meta', $this->apply_user_function($value, $is_php, $php_func), $item);
                ...
                case "wc-product-attr":
                    ...
                    if ($isTax) {
                        ...
                        $taxName = isset($field_option['taxName']) ? rch_sanitize_field($field_option['taxName']) : "";
                    ...
                    $export_data[$field_name . "_value"] = apply_filters('rch_export_product_attribute_value', $this->apply_user_function(!empty($value) ? implode('|', $value) : "", $is_php, $php_func), $item);
    ...
    public function rch_export_product_meta($meta_value = "", $meta_key = "", $item = null) {
