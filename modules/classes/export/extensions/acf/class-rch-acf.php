...
class RCH_ACF {
        ...
        public function __construct() {
                ...
                add_filter( 'rch_pre_item_meta', array( $this, "rch_pre_item_meta" ), 10, 2 );
        }

        public function rch_pre_item_meta( $meta = [], $key = "" ) {
        ...
        public function pre_process_fields( &$export_fields = array(), $export_type = array() ) {
                ...
                if ( ! empty( $acfs ) ) {
                        ...
                        foreach ( $acfs as $key => $acf ) {
                                ...
                                $field_key = 'rch_acf_field_' . $count;
                                ...
                                if ( ! empty( $group_id ) && is_numeric( $group_id ) ) {
                                        ...
                                        if ( ! empty( $acf_fields ) ) {
                                                ...
                                                foreach ( $acf_fields as $field ) {
                                                        ...
                                                        $options = isset( $field->post_content ) ? maybe_unserialize( $field->post_content ) : array();
                                                ...
                                                case 'group':
                                                        ...
                                                        if ( ! empty( $sub_fields ) ) {
                                                                ...
                                                                foreach ( $sub_fields as $s_field ) {
                                                                        ...
                                                                        $s_field_id = isset( $s_field[ 'name' ] ) ? $s_field[ 'name' ] : "";

                                                                        $new_field = $this->add_cf_options( $s_field_id );

                                                                        if ( ! empty( $new_field ) ) {
                                                                                $field_list[] = [
                                                                                        "key" => $name . "_" . $new_field ];
                                                                        }
                                                                }
                                                        }
