...
class RCH_WPML_Export extends \rch\export\base\RCH_Export_Base {
    ...
    public function init_process($template_options = array()) {
        if (isset($template_options['rch_wpml_lang']) && !empty($template_options['rch_wpml_lang'])) {
            do_action('wpml_switch_language', rch_sanitize_field($template_options['rch_wpml_lang']));
        }
    }
        ...
        if ($field_type && in_array($field_type, array("wpml_trid", "wpml_lang", "wpml_translation_title","wpml_translation_slug"))) {
            ...
            switch ($field_type) {
                ...
                case 'wpml_trid':
                    ...
                    $export_data[$field_name] = apply_filters('rch_export_wpml_trid_field', $this->apply_user_function($wpml_original_element_id, $is_php, $php_func), $item);
                ...
                case 'wpml_lang':
                    ...
                    $export_data[$field_name] = apply_filters('rch_export_wpml_language_code', $this->apply_user_function($language_code, $is_php, $php_func), $item);
                ...
                case 'wpml_translation_title':
                    ...
                    $export_data[$field_name] = apply_filters('rch_export_wpml_language_title', $this->apply_user_function($title, $is_php, $php_func), $item);
                ...
                case 'wpml_translation_slug':
                    ...
                    $export_data[$field_name] = apply_filters('rch_export_wpml_language_slug', $this->apply_user_function($title, $is_php, $php_func), $item);
