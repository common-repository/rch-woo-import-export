<div class="rch_acf_item_wrapper" >
    ...
    <div class="rch_field_mapping_image_separator_wrapper">
        ...
        <input type="text" class="rch_content_data_input rch_item_delim rch_item_acf_delim_<?php echo esc_attr($field_key) ?>" name="acf[<?php echo esc_attr($field_key) ?>][delim]" value=","/>
    </div>
    <textarea class="rch_content_data_textarea rch_item_acf" name="acf<?php echo esc_attr($parent_field_key); ?>[<?php echo esc_attr($field_key) ?>][value]"></textarea>
