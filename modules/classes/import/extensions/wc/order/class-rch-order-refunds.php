...
namespace rch\import\wc\order\refunds;
...
class RCH_Order_Refunds extends \rch\import\base\RCH_Import_Base {
        ...
        private function prepare_refunds() {
                ...
                $refund_amount = rch_sanitize_field( $this->get_field_value( 'rch_item_order_item_refund_amount' ) );

                if ( ! empty( $refund_amount ) ) {

                        global $wpdb;

                        $delimiter = rch_sanitize_field( $this->get_field_value( 'rch_item_order_item_refund_delim' ) );

                        $refund_amount = explode( $delimiter, $refund_amount );

                        $refund_reason = rch_sanitize_field( $this->get_field_value( 'rch_item_order_item_refund_reason' ) );

                        $refund_reason = ! empty( $refund_reason ) ? explode( $delimiter, $refund_reason ) : array();

                        $refund_date = rch_sanitize_field( $this->get_field_value( 'rch_item_order_item_refund_date' ) );

                        $refund_date = ! empty( $refund_date ) ? explode( $delimiter, $refund_date ) : array();

                        $refund_post_name = rch_sanitize_field( $this->get_field_value( 'rch_item_order_item_refund_name' ) );
                        ...
                        foreach ( $refund_amount as $_key => $_amount ) {
                                ...
                                if ( $refund instanceOf \WC_Order_Refund ) {
                                        ...
                                        if ( rch_sanitize_field( $this->get_field_value( 'rch_item_order_item_refund_issued_by' ) ) == 'existing' ) {
                                                $customer_id = $this->get_customer_id_by( rch_sanitize_field( $this->get_field_value( 'rch_item_order_item_refund_match_by' ) ) );
                                        }
        ...
        private function get_customer_id_by( $match_by = "" ) {
                ...
                switch ( $match_by ) {
                        ...
                        case "id":
                                ...
                                $customer_id = absint( rch_sanitize_field( $this->get_field_value( 'rch_item_refund_customer_id' ) ) );
                        ...
                        case "email":
                                ...
                                $email = rch_sanitize_field( $this->get_field_value( 'rch_item_refund_customer_email' ) );
                        ...
                        case "login":
                                ...
                                $user_login = rch_sanitize_field( $this->get_field_value( 'rch_item_refund_customer_login' ) );
                        ...
                        case "cf":
                                ...
                                $meta_key = rch_sanitize_field( $this->get_field_value( 'rch_item_refund_customer_meta_key' ) );

                                $meta_val = rch_sanitize_field( $this->get_field_value( 'rch_item_refund_customer_meta_val' ) );
