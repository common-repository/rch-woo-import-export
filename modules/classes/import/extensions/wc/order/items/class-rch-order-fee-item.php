...
class RCH_Order_Fee_Item extends \rch\import\base\RCH_Import_Base {
    ...
    private function prepare_order_fee() {
        ...
        $delimiter = rch_sanitize_field($this->get_field_value('rch_item_order_item_fees_delim'));

        $fee_name = rch_sanitize_field($this->get_field_value('rch_item_order_item_fee'));

        $fee_amount = rch_sanitize_field($this->get_field_value('rch_item_order_item_fee_amount'));
