...
namespace rch\import\wc\order\address;
...
class RCH_Order_Address extends \rch\import\base\RCH_Import_Base {
    ...
    private function prepare_billing() {
        ...
        $source = rch_sanitize_field($this->get_field_value('rch_item_order_billing_source', true));
            ...
            switch ($source) {
                ...
                case "existing":
                    ...
                    if (absint($customer_id) > 0) {
                        ...
                        $no_match_as_guest = absint(rch_sanitize_field($this->get_field_value('rch_item_order_billing_no_match_guest')));

                        if ($no_match_as_guest == 1) {

                            foreach ($this->fields as $field) {

                                $this->billing[$field] = rch_sanitize_field($this->get_field_value('rch_item_guest_billing_' . $field));
                            }
                        }
                ...
                default:
                    ...
                    foreach ($this->fields as $field) {
                        ...
                        $this->billing[$field] = rch_sanitize_field($this->get_field_value('rch_item_billing_' . $field));
                    }
    ...
    private function prepare_shipping() {
        ...
        $source = rch_sanitize_field($this->get_field_value('rch_item_order_shipping_source', true));
            ...
            switch ($source) {
                ...
                default:
                    ...
                    foreach ($this->fields as $field) {
                        ...
                        $field_value = rch_sanitize_field($this->get_field_value('rch_item_shipping_' . $field));
                    ...
                    if ($is_empty) {
                        ...
                        foreach ($this->fields as $field) {
                            ...
                            $shipping[$field] = rch_sanitize_field($this->get_field_value('rch_item_shipping_' . $field));
                        }
                    }
                    unset($is_empty);
    ...
    private function get_customer() {
        ...
        $indicator = rch_sanitize_field($this->get_field_value('rch_item_order_billing_match_by'));

        if ($indicator == "id") {

            $_id = absint(rch_sanitize_field($this->get_field_value('rch_item_order_billing_match_by_user_id')));
            ...
            $email = rch_sanitize_field($this->get_field_value('rch_item_order_billing_match_by_email'));
            ...
            $user_login = rch_sanitize_field($this->get_field_value('rch_item_order_billing_match_by_username'));
            ...
            $meta_key = rch_sanitize_field($this->get_field_value('rch_item_order_billing_match_by_cf_name'));

            $meta_val = rch_sanitize_field($this->get_field_value('rch_item_order_billing_match_by_cf_value'));
