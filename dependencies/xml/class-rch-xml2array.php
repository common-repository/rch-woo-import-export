...
namespace rch\lib\xml\xml2array;
...
class XmlToArray {
        ...
        public function set_xpath( $xpath = "" ) {
                ...
                if ( ! empty( $xmlns ) ) {
                        $this->domxpath->registerNamespace( 'rchns', $xmlns );
                        $xpath = '//rchns:' . substr( $xpath, 2 );
                }
        ...
        public function get_tags() {
                if ( $this->xpathelement !== false && $this->xpathelement->length > 0 ) {
                        $this->rch_filtering_element = array();
        ...
        private function get_tag_list( \DOMElement $element, $originPath = '', $lvl = 0 ) {
                ...
                if ( "" != $path ) {
                        ...
                        $filtering_elements[] = $path . '[' . $this->rch_filtering_element[ $path ] . ']';
                } else {
                        $path = $element->nodeName;
                }
